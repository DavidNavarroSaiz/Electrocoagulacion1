...
#define lcdDB4 LATBbits.LATB4 // Maneja el pin DB4 de la LCD
#define lcdDB5 LATBbits.LATB5 // Maneja el pin DB5 de la LCD
#define lcdDB6 LATBbits.LATB6 // Maneja el pin DB6 de la LCD
#define lcdDB7 LATBbits.LATB7 // Maneja el pin DB7 de la LCD
#define LCD_RS  LATBbits.LATB2 // Maneja el pin R/S de la LCD
#define LCD_EN  LATBbits.LATB3 // Maneja el pin Enable de la LCD

// 1.2 Configuracion de los Tris manejados por los pines de comunicación a la
//      LCD
#define T_LCD_DATA_DB4 TRISBbits.TRISB4 // Para DB4
#define T_LCD_DATA_DB5 TRISBbits.TRISB5 // Para DB5
#define T_LCD_DATA_DB6 TRISBbits.TRISB6 // Para DB6
#define T_LCD_DATA_DB7 TRISBbits.TRISB7 // Para DB7
#define T_LCD_RS  TRISBbits.TRISB2 // Para R/S
#define T_LCD_EN  TRISBbits.TRISB3 // Para Enable
